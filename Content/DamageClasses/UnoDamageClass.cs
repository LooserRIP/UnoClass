...
namespace UnoClass.Content.DamageClasses
{
	public class UnoDamageClass : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			//player.GetCritChance<UnoDamageClass>() += 4;
			//player.GetArmorPenetration<UnoDamageClass>() += 10;
